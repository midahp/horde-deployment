 ...
 *
 */
$_SERVER['REQUEST_URI'] = substr_replace($_SERVER['REQUEST_URI'], '/horde/rpc/', -8, 5);
$_SERVER['SCRIPT_FILENAME'] = substr_replace($_SERVER['SCRIPT_FILENAME'], '/horde', -10, 0);
$_SERVER['SCRIPT_NAME'] = substr_replace($_SERVER['SCRIPT_NAME'], '/horde', -10, 0);
$_SERVER['PHP_SELF'] = substr_replace($_SERVER['PHP_SELF'], '/horde', -10, 0);
